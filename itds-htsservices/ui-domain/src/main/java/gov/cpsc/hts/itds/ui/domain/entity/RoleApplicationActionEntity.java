...
@Entity
@Table(name = "ROLE_APPLICATION_ACTION")
public class RoleApplicationActionEntity  extends BaseItdsEntity{
	
	private static final long serialVersionUID = 6713939486604672811L;
	public RoleApplicationActionEntity() {
		super();
	}
	
	@EmbeddedId
	private RoleApplicationActionEntityId id;
