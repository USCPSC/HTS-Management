...
import com.ttw.itds.ui.domain.entity.CpscHtsManagementFileEntity;
import com.ttw.itds.ui.domain.entity.CpscHtsMgmtHistEntity;
import com.ttw.itds.ui.domain.repository.CpscHtsManagementFileRepository;
import com.ttw.itds.ui.domain.repository.CpscHtsManagementRepository;
import com.ttw.itds.ui.domain.repository.CpscHtsMgmtHistRepository;
...
public class HtsStateTransitionService {
    ...
    public String stateTransitionAsInfix() {
    	StateTuple stateTuple = findLatestStateTuple();
		return "\", \"stateTransition\": \"" + stateTuple.transition + "\", \"transitioningNow\": \"" + (stateTuple.inference == HtsGlobalStateEnum.IN_TRANSITION) 
    				+ "\", \"stateTransitionTimestamp\": \"" + stateTuple.eventDate;
    }
	...
	public String summarizeLastUpload() {
		String result = "";
